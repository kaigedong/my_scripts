IO多路复用；操作系统的锁，信号量，条件变量等任务同步方面的相关知识；Linux的五种IO模型
...
> 以上对epoll的原理说的并不清楚，对为什么需要epoll说的挺清楚

+ [参考(据说来自知乎)](https://www.zhihu.com/question/20122137/answer/14049112)
+ [参考2我还没读过，不知怎么样](http://luodw.cc/2016/01/24/epoll/)
